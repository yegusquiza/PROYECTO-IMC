...
export default function ProyectoIMC ()  {
  ...
  return (
    <div className='container'>
      <div className='row center'>
        <h1 className='white-text'> CALCULADORA DE INDICE CORPORAL </h1>
      </div>
        <div className='row'>
        ...
        <div className='row center'>
          <h2 className='white-text'>DATOS DE LOS ULTIMOS DIAS</h2>
        </div>
        <div className='data-container row'>
          ...
          : <h3 className='white-text center'>Ingresar datos</h3> }
        </div>
    </div>
  );
}